...
### `dir_validate()`
`dir_validate()` checks the given file path to see whether it contains any non-existing folder. If yes, this function automatically creates the folder(s) to ensure the path is available. Useful when generating a file name for saving.
```{r}
